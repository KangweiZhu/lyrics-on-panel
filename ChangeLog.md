...
directly via the KDE Store or the `Add and Manage Widgets` section in panel configuration. The second version splits the v1 widget into frontend and backend; the frontend polls the backend for lyrics, necessary info of the currently playing track, and available media players, and it sends media control commands back to the backend.

#### Key changes

1. Now all the available players will be shown and able to select whne the media icon is left-clicked.
2. The widget is supporting `splayer mode` now! ([neokoni](https://github.com/KangweiZhu/lyrics-on-panel/pull/21))
3. The widget has been ported to DankMaterialShell now!

----

### [v1.4 05/23/2025]  Last Pure-QML Edition
...
7. The widget is supporting **LX-Music Mode** Now! ([ChouYih](https://github.com/KangweiZhu/lyrics-on-panel/issues/7))
...
9. Spotify White icon is now added.
...
### [v1.3 05/29/2024] Major Bug Fix, Improve Accuracy
...
### [v1.1 & v1.2 05/28/2024] BRING THIS WIDGET BACK TO LIVE IN PLASMA6
